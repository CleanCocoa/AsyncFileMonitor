//
//  FileSystemEventExecutor.swift
//  AsyncFileMonitor
//
//  Custom executor for file system event handling that implements both
//  SerialExecutor and TaskExecutor according to SE-0417.
//
...
final class FileSystemEventExecutor: SerialExecutor, TaskExecutor {
	static let shared = FileSystemEventExecutor(
		label: "AsyncFileMonitor_FileSystemEventExecutor",
		qos: .userInteractive
	)
	...
	static func isCurrentTaskExecutor(_ executor: FileSystemEventExecutor) -> Bool {
